    ...
    <section className="mx-auto max-w-[1152px] px-6 py-20">
      ...
      <div className="mt-12 grid gap-6 md:grid-cols-2">
        ...
        >
          ...
          <a href="tel:+4915213629639" className="mt-4 block font-display text-2xl text-primary hover:underline md:text-3xl">
            +49 1521 3 629 639
          </a>
        </motion.div>
        ...
        >
          ...
          <p className="mt-1 text-sm text-muted-foreground">Got an idea? A role? A random thought? I'm listening.</p>
          <a href="mailto:saurabhjha95@gmail.com" className="mt-4 block font-display text-2xl text-primary hover:underline md:text-3xl">
